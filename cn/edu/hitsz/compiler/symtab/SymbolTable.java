...
public class SymbolTable {
    ...
    private Map<String, SymbolTableEntry> symtbl = new HashMap<>();
...
//        throw new NotImplementedException();
        // TODO:
        if(!this.has(text)) {
            SymbolTableEntry ste = new SymbolTableEntry(text);
            symtbl.put(text, ste);
            return ste;
        }
        return null;
...
//        throw new NotImplementedException();
        // TODO:
        return symtbl.containsKey(text);
    }
